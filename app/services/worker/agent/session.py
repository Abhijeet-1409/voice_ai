...
def create_agent_session(api_key: str, user_data: UserData) -> AgentSession:
    """
    ...
    # Converting user_data dataclass to dictionary for easier handling within the session state
