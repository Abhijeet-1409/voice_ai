...
LIMITS = httpx.Limits(keepalive_expiry=30,max_keepalive_connections=5, max_connections=10)
_http_client = httpx.AsyncClient(timeout=30, limits=LIMITS) 


async def transcribe(wav_path: str, session_id: str) -> str:
    """
